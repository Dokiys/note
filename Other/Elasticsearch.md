...
![数据结构](../asset/Zoo/Elasticsearch/数据结构.jpg)
...
![缓存文档](../asset/Zoo/Elasticsearch/%E7%BC%93%E5%AD%98%E6%96%87%E6%A1%A3.png)
...
![未提交的段](../asset/Zoo/Elasticsearch/%E6%9C%AA%E6%8F%90%E4%BA%A4%E7%9A%84%E6%AE%B5.png)
...
1. 新的文档被添加到内存缓冲区并且被追加到了事务日志
   ...
   ![新文档添加](../asset/Zoo/Elasticsearch/%E6%96%B0%E6%96%87%E6%A1%A3%E6%B7%BB%E5%8A%A0.png)

2. 刷新（refresh）完成后, 缓存被清空但是事务日志不会

   ![记录日志](../asset/Zoo/Elasticsearch/%E8%AE%B0%E5%BD%95%E6%97%A5%E5%BF%97.png)

3. 更多的文档被添加

   ![日志累积](../asset/Zoo/Elasticsearch/%E6%97%A5%E5%BF%97%E7%B4%AF%E7%A7%AF.png)

4. 全量提交被执行，一个新的 translog 被创建。

   ![flush提交](../asset/Zoo/Elasticsearch/flush%E6%8F%90%E4%BA%A4.png)
...
2. 并进程会在不中断索引和搜索的请空下，选择一小部分大小相似的段，并且在后台将它们合并到更大的段中。
   ![段合并](../asset/Zoo/Elasticsearch/%E6%AE%B5%E5%90%88%E5%B9%B6.png)
3. 新的段被刷新（flush）到了磁盘，写入一个新的提交点，新段打开，老段删除。
   ![段删除](../asset/Zoo/Elasticsearch/%E6%AE%B5%E5%88%A0%E9%99%A4.png)
...
![两节点](../asset/Zoo/Elasticsearch/%E4%B8%A4%E8%8A%82%E7%82%B9.png)

当对集群进行水平扩容时，`Node 1` 和 `Node 2` 上各有一个分片被迁移到了新的 `Node 3` 节点，现在每个节点上都拥有2个分片：

![水平扩容](../asset/Zoo/Elasticsearch/%E6%B0%B4%E5%B9%B3%E6%89%A9%E5%AE%B9.png)

扩容后每个节点的硬件资源（CPU, RAM, I/O）将被更少的分片所共享，每个分片的性能将会得到提升，所以提高副本数量也能够提升Elasticsearch 性能。

当关闭一个节点后，将会自动重新选择主节点：

![缩容](../asset/Zoo/Elasticsearch/%E7%BC%A9%E5%AE%B9.png)
...
![写操作](../asset/Zoo/Elasticsearch/%E5%86%99%E6%93%8D%E4%BD%9C.png)
...
![局部更新](../asset/Zoo/Elasticsearch/%E5%B1%80%E9%83%A8%E6%9B%B4%E6%96%B0.png)
...
![查询阶段](../asset/Zoo/Elasticsearch/%E6%9F%A5%E8%AF%A2%E9%98%B6%E6%AE%B5.png)
...
![取回阶段](../asset/Zoo/Elasticsearch/%E5%8F%96%E5%9B%9E%E9%98%B6%E6%AE%B5.png)
