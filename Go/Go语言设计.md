...
![defer链表](../asset/Go/Go%E8%AF%AD%E8%A8%80%E8%AE%BE%E8%AE%A1/chrome_wQFGPO3XOj.png)
...
![1.13](../asset/Go/Go%E8%AF%AD%E8%A8%80%E8%AE%BE%E8%AE%A1/chrome_q0FJ2l3pRV.png)
...
![panicA](../asset/Go/Go%E8%AF%AD%E8%A8%80%E8%AE%BE%E8%AE%A1/chrome_KEpz0G2gad.png)
...
![panicA2](../asset/Go/Go%E8%AF%AD%E8%A8%80%E8%AE%BE%E8%AE%A1/chrome_0TDtunoJEz.png)

此时开始执行`B1()`，`recover()`将`_panic`链中的第一个`panic`标记为恢复，然后打印输出：

![recovered](../asset/Go/Go%E8%AF%AD%E8%A8%80%E8%AE%BE%E8%AE%A1/chrome_QpkklaBluz.png)

当`B1()`执行完，返回到上一次的`panic`触发位置，即`3`。此时会去检查`B2()`在`_panic`中创建的`panicB2`，发现已经被恢复，将其从`_panic`中移除：

![aborted](../asset/Go/Go%E8%AF%AD%E8%A8%80%E8%AE%BE%E8%AE%A1/chrome_A4uxt82ZKK.png)

此时`A2()`也执行完，返回到`A()`中的`1`处，继续执行`_defer`链中的`A1()`：

![remove](../asset/Go/Go%E8%AF%AD%E8%A8%80%E8%AE%BE%E8%AE%A1/chrome_f0rjtvOkcU.png)
